...
# Global H4 + M30 fractal sweep & engulfing (BTC / ETH / XAU)
GLOBAL_HTF_INTERVAL = os.environ.get("GLOBAL_HTF_INTERVAL", "1h")
GLOBAL_ENTRY_INTERVAL = os.environ.get("GLOBAL_ENTRY_INTERVAL", "30m")
...
GLOBAL_M30_LOOKBACK_BARS = max(1, int(os.environ.get("GLOBAL_M30_LOOKBACK_BARS", "96")))
