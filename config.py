...
# Global BTC/ETH/XAU — multi-strategy engine (EMA/VWAP/Breakout/Retest/ORB) on 15m + 5m ORB
...
GLOBAL_VOLUME_MULT = float(os.environ.get("GLOBAL_VOLUME_MULT", "1.5"))
GLOBAL_MIN_SIGNAL_SCORE = float(os.environ.get("GLOBAL_MIN_SIGNAL_SCORE", "70"))
