...
# Global BTC/ETH/XAU — EMA 9/21 + MACD (34/144/9) on 15m candles
GLOBAL_ENTRY_INTERVAL = os.environ.get("GLOBAL_ENTRY_INTERVAL", "15m")
GLOBAL_EMA_FAST = int(os.environ.get("GLOBAL_EMA_FAST", "9"))
GLOBAL_EMA_SLOW = int(os.environ.get("GLOBAL_EMA_SLOW", "21"))
GLOBAL_MACD_FAST = int(os.environ.get("GLOBAL_MACD_FAST", "34"))
GLOBAL_MACD_SLOW = int(os.environ.get("GLOBAL_MACD_SLOW", "144"))
GLOBAL_MACD_SIGNAL = int(os.environ.get("GLOBAL_MACD_SIGNAL", "9"))
GLOBAL_RR_RATIO = float(os.environ.get("GLOBAL_RR_RATIO", "2.0"))
GLOBAL_LONDON_START_HOUR = int(os.environ.get("GLOBAL_LONDON_START_HOUR", "8"))
GLOBAL_LONDON_END_HOUR = int(os.environ.get("GLOBAL_LONDON_END_HOUR", "16"))
GLOBAL_NY_START_HOUR = int(os.environ.get("GLOBAL_NY_START_HOUR", "13"))
GLOBAL_NY_END_HOUR = int(os.environ.get("GLOBAL_NY_END_HOUR", "22"))
GLOBAL_ENABLE_BUY = os.environ.get("GLOBAL_ENABLE_BUY", "true").lower() in ("1", "true", "yes")
GLOBAL_ENABLE_SELL = os.environ.get("GLOBAL_ENABLE_SELL", "true").lower() in ("1", "true", "yes")
GLOBAL_CRYPTO_24H = os.environ.get("GLOBAL_CRYPTO_24H", "true").lower() in ("1", "true", "yes")
GLOBAL_LOOKBACK_BARS = max(1, int(os.environ.get("GLOBAL_LOOKBACK_BARS", os.environ.get("GLOBAL_M30_LOOKBACK_BARS", "96"))))
# Legacy (unused — kept for .env compatibility)
GLOBAL_HTF_INTERVAL = os.environ.get("GLOBAL_HTF_INTERVAL", "1h")
GLOBAL_FRACTAL_BARS = int(os.environ.get("GLOBAL_FRACTAL_BARS", "2"))
GLOBAL_ENGULF_ATR_MULT = float(os.environ.get("GLOBAL_ENGULF_ATR_MULT", "0.35"))
GLOBAL_M30_LOOKBACK_BARS = GLOBAL_LOOKBACK_BARS
...
# Legacy alert trail cap — GTT orders use NIFTY/SENSEX target points only (see gtt_premium_levels.py)
NIFTY_OPTION_PREMIUM_TRAIL_MAX_POINTS = float(os.environ.get("NIFTY_OPTION_PREMIUM_TRAIL_MAX_POINTS", "30"))
SENSEX_OPTION_PREMIUM_SL_POINTS = float(os.environ.get("SENSEX_OPTION_PREMIUM_SL_POINTS", "20"))
SENSEX_OPTION_PREMIUM_TARGET_POINTS = float(os.environ.get("SENSEX_OPTION_PREMIUM_TARGET_POINTS", "50"))
